...
## 事前準備
今天要繼續實作的程式是延續 [[Day-28] (實作)使用 joi 驗證POST資料](https://ithelp.ithome.com.tw/articles/10196310) 的專案繼續實作，想跟著今天的實作可以先下載下面的整包程式，記得要先 `yarn install` 將整個依賴的軟體安裝回來。
...
![https://ithelp.ithome.com.tw/upload/images/20180108/20107247SljOfto2AS.png](https://ithelp.ithome.com.tw/upload/images/20180108/20107247SljOfto2AS.png)
...
![https://ithelp.ithome.com.tw/upload/images/20180108/20107247DzBkEVfBQu.png](https://ithelp.ithome.com.tw/upload/images/20180108/20107247DzBkEVfBQu.png)
![https://ithelp.ithome.com.tw/upload/images/20180108/20107247NgyjpPMsS4.png](https://ithelp.ithome.com.tw/upload/images/20180108/20107247NgyjpPMsS4.png)

##### 3. GET 查看結果
在 Postman 的網址列輸入 `localhost:3000/api/user` 並選擇 GET 請求方式，最後再點選 Send 送出。你會發現密碼真的被加密成功了！

![https://ithelp.ithome.com.tw/upload/images/20180108/20107247UZQvxngYDk.png](https://ithelp.ithome.com.tw/upload/images/20180108/20107247UZQvxngYDk.png)
...
![https://ithelp.ithome.com.tw/upload/images/20180108/20107247r1tPcIUHFo.png](https://ithelp.ithome.com.tw/upload/images/20180108/20107247r1tPcIUHFo.png)

範例程式碼：https://github.com/andy6804tw/RESTful_API_start_kit/releases/tag/V12.0.0

文章同時發表於：https://andy6804tw.github.io/2018/01/08/user-bcrypt/
